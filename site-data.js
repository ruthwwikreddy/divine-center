...
window.DivineCenter = (function () {
  ...
  function renderPanditListingCard(p, linkPage) {
    ...
    return (
      ...
      tags +
      "</div>" +
      '<span class="pandit-listing__cta">View profile <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M9 18l6-6-6-6"/></svg></span>' +
      "</div></a>"
    );
  }
